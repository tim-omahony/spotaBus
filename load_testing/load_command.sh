...
locust -f locust.py --host http://localhost:8000/login -users 1000 --spawn-rate 30
locust -f locust.py --host http://localhost:8000/register -users 1000 --spawn-rate 30
...
locust -f locust.py --host http://localhost:8000/login -users 1000 --spawn-rate 200
locust -f locust.py --host http://localhost:8000/register -users 1000 --spawn-rate 200